...
function agentsMd() {
  return [
    ...
    '## Autonomy', '',
    '**AUTO (default)** — follow the spec, decide + log + continue, do NOT stop to ask.',
    'Hard-stops only: security · irreversible/outbound actions · a contradictory spec.',
    'Blockers are parked + reported at the phase boundary, not mid-flow. **GUIDED** asks',
    'at each fork. Declare the mode in `docs/OVERVIEW.md`. See METHODOLOGY → Autonomy.', '',
